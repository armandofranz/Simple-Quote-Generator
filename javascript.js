...
function newQuote(){
    var randomNumber = Math.floor(Math.random() * quotes.length);
            ...
            quoteDisplay.innerHTML = "<p>" + quoteObj.quote + "</p>";
            quoteDisplay.innerHTML += "<p>- " + quoteObj.author + "</p>";
            quoteDisplay.innerHTML += "<p><strong>Topics:</strong> " + quoteObj.topics.join(", ") + "</p>";
}
